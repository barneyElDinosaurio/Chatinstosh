...
public final class Config {
	...
	public static final String BUG_REPORTS = "bugs@caht.im";


	public static final String DOMAIN_LOCK = "twoanonim.duckdns.org"; //only allow account creation for this domain
	public static final String MAGIC_CREATE_DOMAIN = "twoanonim.duckdns.org";
